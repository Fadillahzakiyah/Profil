...
<html>
    ...
    <!-- Menampilkan tombol MENU -->
        ...
        <!-- Menampilkan kotak profil -->
        <section id="box-profile">
        <!-- Menampilkan gambar profil -->
            <div class="img-profile">
                <div class="photo" style="background-image: url(assets/img/profil.png);"></div>
            </div>
            <!-- Menampilkan nama, pekerjaan, deskripsi -->
            <div class="description">
                <h1 id="pName"><?php echo $nama; ?></h1>
                <p id="pRole"><?php echo $role; ?></p>
                <a href="#input-form" class="button bg-peru" onclick="editForm()">Edit</a>
                <a href="#" class="button border-brown">Resume</a>
            </div>
            <!-- Menampilkan data-data profil -->
            <div class="information">
                <div class="data">
                    <p class="field">Availabelity</p>
                    <p id="pAvailable" class="text-grey"><?php echo $availabelitiy; ?></p>
                </div>
                <div class="data">
                    <p class="field">Age</p>
        ...
        <section id="input-form">
            <form method="#" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <div>
                    <label>Availabelity</label>
                     <input id="inpAvailabelity" type="text" name="availabelity">
                </div>
                <div class="form">
                    <label>Age</label>
                ...
                <div class="form">
                     <input onclick="simpanMenu()" type="submit" name="submit" value="SUBMIT"class="bg-brown">
                </div>
            </form>
        </section>
        ...
        <script>
            ...
            function editForm(){
                ...
                document.getElementById("inpAvailabelity").value = available;
